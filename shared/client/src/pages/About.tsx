...
export default function About() {
  return (
    <div className="about-page">
      ...
      <section className="about-contact section-pad" id="contact"><div className="page-width about-contact__grid"><div><Sparkles size={21} /><h2>The next chapter<br /><em>starts here.</em></h2></div><div><p>For questions about Ebi Tsū, the collection, or what may be coming next, reach out directly. We’ll be glad to hear from you.</p><a className="contact-placeholder" href="mailto:Ebi-Tsu@outlook.com"><Mail size={16} /> Ebi-Tsu@outlook.com <ArrowUpRight size={15} /></a><span className="about-contact__note">© 2026 Ebi Tsū. All rights reserved.<br />The Shrimp Connoisseur.</span></div></div></section>
    </div>
  );
}
